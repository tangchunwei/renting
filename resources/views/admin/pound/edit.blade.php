...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：手续费管理&nbsp;&nbsp;>&nbsp;&nbsp;添加</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <form method="post" action="/admin/pound/{{$data->id}}">
    {{ csrf_field() }}
    {{ method_field('PUT') }}
    ...
    @if($errors->has('error'))
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
            <input type="text" name="toll_item" value="{{$data->toll_item}}" class="text-word" placeholder="input" style="width:580px;">
        </td>
    </tr>
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
            <input type="number" name="sum"  value="{{$data->sum}}" class="text-word" placeholder="input" style="width:580px;">
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">备注：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
            <input type="text" name="remark" value="{{$data->remark}}" class="text-word" placeholder="input" style="width:580px;">
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
