...
<body style="backgroud-color:#ccc;">
  <select name="" id="selectPay" class="form-control" style="width:100px;">
    <option value="rent" @if($table == 'rent') selected @endif>房租</option>
    <option value="water" @if($table == 'water') selected @endif>水费</option>
    <option value="electric" @if($table == 'electric') selected @endif>电费</option>
    <option value="property" @if($table == 'property') selected @endif>物业费</option>
  </select>
      ...
      <td align="left" valign="top">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
          <tr>
            ...
            <th align="center" valign="middle" class="borderright">费用</th>
            <th align="center" valign="middle" class="borderright">已交费用</th>
          </tr>
          @foreach($data as $k=>$v)
  ...
  <script>
    ...
    select.addEventListener('change', function(){
      location.href = '/admin/payment/details?table='+this.value;
    })
  </script>
</body>
